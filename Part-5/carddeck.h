...
namespace cards {
    ...
    const std::string DESCRIPTION[DECK_SIZE] = {
            ...
            "You can have a free move before rolling your dicefacility.",
            ...
            "Other Monsters must always use their rerolls. (They still get to choose which dicefacility to reroll).",
            ...
            "You can discard as many Celebrity as you wish. For each Celebrity discarded, you can change the face of one of the dicefacility you haven't resolved.",
